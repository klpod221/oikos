...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('nutrition_logs', function (Blueprint $table) {
            ...
            $table->decimal('quantity', 10, 2)->nullable(); // If logging raw ingredient
            $table->decimal('servings', 10, 2)->default(1); // If logging recipe
            ...
            // Index for daily nutrition queries
