      ...
      <div class="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <span class="text-slate-700">
                <span class="font-semibold"
                  >{{ ing.pivot?.quantity }} {{ ing.pivot?.unit }}</span
                >
                {{ ing.name }}
              </span>
            </li>
        ...
        <div class="md:col-span-2">
          ...
          <div class="space-y-4">
            ...
            >
              <div
                class="shrink-0 w-8 h-8 rounded-full bg-slate-100 text-slate-500 font-bold flex items-center justify-center border border-slate-200"
              >
                {{ index + 1 }}
              </div>
